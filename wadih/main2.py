...
# Voeg deze lijnen toe na window.config(background="#12BDAC")
...
def reset():
    ...
    # Build our buttons (pas op met bg=)   window.config(background="#12BDAC")
    ...
    # Verplaats deze lijn van reset() naar hier
...
# Voeg deze lijn toe na my_menu = Menu(window)
my_menu = Menu(window)
